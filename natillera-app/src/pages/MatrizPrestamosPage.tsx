...
import { MatrizPrestamosView } from "@/components/dashboard/MatrizPrestamosView";

export function MatrizPrestamosPage({ onVolver }: { onVolver: () => void }) {
  const { data, loading, error, reload } = useApi(() => api.matrizPrestamos(), []);
  ...
  return (
    <div className="space-y-4">
      ...
      {data && <MatrizPrestamosView matriz={data} />}
    </div>
  );
}
